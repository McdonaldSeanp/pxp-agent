plan pxp_dev::build (
  ...
  run_task('pxp_dev::run_pxp_make', 'build_host')

  # run_task('service', $target_agents, action => 'stop', name => 'pxp-agent')
  # run_task('service', $target_agents, action => 'start', name => 'pxp-agent')
